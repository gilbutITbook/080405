...
class JsonBColumn<T : Any>(
    ...
    override fun notNullValueToDB(value: T): String = toJson(value as T)
    override fun nonNullValueToString(value: T): String = "'${notNullValueToDB(value)}'"
}


class JsonBValue<T:Any>(
    val expr: Expression<*>,
...
inline fun <reified T:Any> Column<*>.json(vararg jsonPath: String): JsonBValue<T> {
    ...
    return JsonBValue<T>(this, columnType as ColumnType<T>, jsonPath.toList())
}
